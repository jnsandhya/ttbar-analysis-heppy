...
class MuonSF(Analyzer):

    def __init__(self, cfg_ana, cfg_comp, looperName):
        super(MuonSF, self).__init__(cfg_ana, cfg_comp, looperName)
        ...
        if self.year == '2016':
            rootfname_id_1 = '/'.join([os.environ["CMSSW_BASE"],
                                     'src/CMGTools/ttbar/data/2016/muonSF/RunBCDEF_SF_ID.root'])                       
            rootfname_iso_1 = '/'.join([os.environ["CMSSW_BASE"],
                              'src/CMGTools/ttbar/data/2016/muonSF/RunBCDEF_SF_ISO.root'])
            rootfname_id_2 = '/'.join([os.environ["CMSSW_BASE"],
                           'src/CMGTools/ttbar/data/2016/muonSF/RunGH_SF_ID.root'])                       
            rootfname_iso_2 = '/'.join([os.environ["CMSSW_BASE"],
                              'src/CMGTools/ttbar/data/2016/muonSF/RunGH_SF_ISO.root'])
