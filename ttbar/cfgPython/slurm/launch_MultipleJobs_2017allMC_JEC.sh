...
#    rm -rf ../emu/$1/emu_${corr}_up_cfg.py $1_${corr}_up 
    ...
    bash launch.sh ../emu/$1/emu_prod_2017allMC_Lyon_${corr}_up_cfg.py $1_${corr}_up
    ...
    bash launch.sh ../emu/$1/emu_prod_2017allMC_AAA_${corr}_up_cfg.py $1_${corr}_up
...
#    rm -rf ../emu/$1/emu_${corr}_down_cfg.py $1_${corr}_down
    ...
    bash launch.sh ../emu/$1/emu_prod_2017allMC_Lyon_${corr}_down_cfg.py $1_${corr}_down
    ...
    bash launch.sh ../emu/$1/emu_prod_2017allMC_AAA_${corr}_down_cfg.py $1_${corr}_down
