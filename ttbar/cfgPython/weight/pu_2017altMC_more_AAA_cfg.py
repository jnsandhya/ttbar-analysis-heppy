...
if (year == '2016'):
    ...
    from CMGTools.ttbar.samples.fall17.ttbar_alternative_2017   import alt_ttbar_more as alt_ttbar
...
for i in range(0,len(selectedComponents)): 
    print selectedComponents[i].name
