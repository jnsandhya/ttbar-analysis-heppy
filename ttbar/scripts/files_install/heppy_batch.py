...
def batchScriptSLURM( index, jobDir='./'):
   '''prepare the SLURM version of the batch script, to run on SLURM'''
   ''' copied from batchScriptPISA'''
   script = """#!/bin/bash
#SBATCH --mem=2048 # Need 2GB / slot
...
class MyBatchManager( BatchManager ):
   ...
   def PrepareJobUser(self, jobDir, value ):
	   ...
	   scriptFile.write( batchScriptSLURM( storeDir, value) ) 	
       elif mode == 'PISA' :
